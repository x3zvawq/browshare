...
import NavigationPolicyPanel from '@/components/navigation-policy/NavigationPolicyPanel.vue'
...
<template>
  <AppShell
    ...
    :breadcrumb-title="t('navigationPolicy.title')"
    @logout="logout"
    ><NavigationPolicyPanel v-if="id" :key="id" :profile-id="id" :can-manage="canManage"
  /></AppShell>
</template>
